...
class _PostFeed extends State<PostFeed> {
  List<PostItem> _posts = [];
   final String _dataTarget = 'image-post-cool.json';
   final String _storageTarget = "cool-img";
  @override
  void initState() {
          ...
          children: [GridView.builder(
              ...
              itemBuilder: (ctx, index) => Column(
                    children: [
                      ...
                      Container(
                        color: const Color.fromARGB(255, 255, 255, 255),
                        child: Text(_posts[index].title, style: const TextStyle(fontWeight: FontWeight.w800),),
                      ),
                    ],
                  )
              /*ListTile(
...
class  CoolToneResult extends StatelessWidget {
                ...
                children: [
                 ...
                 const SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [Text('COOL TONE',textAlign: TextAlign.center, style: TextStyle(height: 0,color: Color.fromARGB(255, 182, 127, 98), fontSize: 24,fontWeight: FontWeight.w700, fontFamily: 'montserrat'),),],//,style: TextStyle(fontFamily: 'montserrat'),
                    ),
                  ),
                  Visibility(
                    maintainSize: true,
                ...
                children: [
                  Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        Text(
                            "the colors we suggest",style: TextStyle(fontFamily: 'montserrat'),textAlign: TextAlign.center,),
                      ],
                    ),
                  ),
                  ClipRRect(
                    ...
                    child: const Image(
                      width: 350,
                      fit: BoxFit.fill,
                      image: AssetImage("images/platletCool.png"),
                    ),
                  ),
                  const SizedBox(height: 20,),
                  const Text(
                          "you can tap in picture for more detail",textAlign: TextAlign.center,
                          style: TextStyle(height: 0, fontSize: 12,fontFamily: 'montserrat'),//,style: TextStyle(fontFamily: 'montserrat'),
                        ),
                ],
              ),
              const SizedBox(height: 20,),
