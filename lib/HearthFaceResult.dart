...
class _PostFeed extends State<PostFeed> {
  List<PostItem> _posts = [];
   final String _dataTarget = 'image-post-hearth.json';
   final String _storageTarget = "hearth-img";
  @override
  void initState() {
    print("init");
                ...
                children: [
                 ...
                 const SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [Text('HEARTH FACE', style: TextStyle(color: Color.fromARGB(255, 182, 127, 98), fontSize: 24,fontWeight: FontWeight.w700, fontFamily: 'montserrat'),),],
                    ),
                  ),
                  Visibility(
                    maintainSize: true,
                ...
                children: [
                  Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        Text(
                            "The face has a wide forehead, with a relatively sharp chin. The area from the cheeks to the chin tapers down, creating a narrow jawline.",textAlign: TextAlign.center, style: TextStyle(fontFamily: 'montserrat'),),SizedBox(height: 20,),
