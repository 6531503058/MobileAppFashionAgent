...
class _PostFeed extends State<PostFeed> {
  List<PostItem> _posts = [];
   final String _dataTarget = 'image-post-oval.json';
   final String _storageTarget = "oval-img";
  @override
  void initState() {
    super.initState();
    _loadPost();
...
class  OvalFaceResult extends StatelessWidget {
                ...
                children: [
                 ...
                 const SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [Text('OVAL FACE', style: TextStyle(color: Color.fromARGB(255, 182, 127, 98), fontSize: 24,fontWeight: FontWeight.w700, fontFamily: 'montserrat'),),],
                    ),
                  ),
                  Visibility(
                    maintainSize: true,
                ...
                children: [
                  Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        Text(
                            "With a well-proportioned face, this young woman has the freedom to choose from a variety of hairstyles.",textAlign: TextAlign.center, style: TextStyle(fontFamily: 'montserrat'),),
                             SizedBox(
                          height: 20,
                        ),
                        Text(
